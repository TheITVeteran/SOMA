      ...
      if (targetConv) {
        ...
        msgs.forEach(msg => {
          if (msg.type === 'command' && typeof msg.content === 'string')
            service.conversationHistory.push({ role: 'user', content: msg.content });
          else if (msg.type === 'response' && typeof msg.content === 'string')
            service.conversationHistory.push({ role: 'assistant', content: msg.content });
        });
              ...
              <div className="flex flex-col flex-1 overflow-hidden p-2">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar space-y-1">
                  {conversations.length === 0 ? (
                    ...
                    [...conversations].sort((a, b) => (b.updatedAt || 0) - (a.updatedAt || 0)).map(conv => {
