...
const CommandPalette: React.FC<Props> = ({ isOpen, onClose, onAction }) => {
  ...
  const actions = [
    ...
    { id: 'topology', label: 'View Cluster Topology', icon: <Search className="w-4 h-4" />, cmd: 'topology' },
    { id: 'optimize', label: 'Optimize Network Traffic', icon: <Zap className="w-4 h-4" />, cmd: 'optimize' },
    { id: 'compliance', label: 'Check System Compliance', icon: <ShieldAlert className="w-4 h-4" />, cmd: 'compliance' },
